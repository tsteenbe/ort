...
- Code
  - [plugins/commands/reporter/src/main/kotlin/ReportCommand.kt](https://github.com/boschglobal/oss-review-toolkit/blob/main/plugins/commands/reporter/src/main/kotlin/ReportCommand.kt)
- Tutorials
  - FIXME
