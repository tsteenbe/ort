...
- Code
  - [plugins/commands/scanner/src/main/kotlin/AnalyzeCommand.kt](https://github.com/oss-review-toolkit/ort/blob/main/plugins/commands/analyzer/src/main/kotlin/AnalyzeCommand.kt)
- Tutorials
  - FIXME
