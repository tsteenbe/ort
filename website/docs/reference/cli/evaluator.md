...
- Code
  - [plugins/commands/scanner/src/main/kotlin/EvaluateCommand.kt](https://github.com/oss-review-toolkit/ort/blob/main/plugins/commands/evaluator/src/main/kotlin/EvaluateCommand.kt)
- Tutorials
  - FIXME
