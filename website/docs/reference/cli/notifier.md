...
- Code
  - [plugins/commands/scanner/src/main/kotlin/NotifyCommand.kt](https://github.com/oss-review-toolkit/ort/blob/main/plugins/commands/notifier/src/main/kotlin/NotifyCommand.kt)
- Tutorials
  - FIXME
