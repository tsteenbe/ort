...
If passed an ORT result file with an [ORT Analyzer] result (`-i`), the *ORT Scanner* will automatically download the sources of the dependencies via the [ORT Downloader] and scan them afterward.
...
- Code
  - [plugins/commands/scanner/src/main/kotlin/ScanCommand.kt](https://github.com/boschglobal/oss-review-toolkit/blob/main/plugins/commands/scanner/src/main/kotlin/ScanCommand.kt)
