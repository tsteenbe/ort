...
- Reference
  - [ORT Evaluator CLI --package-curations-file and --repository-configuration-file options](../cli/evaluator.md#configuration-options)
  - [ORT Helper CLI package-curations commands](../cli/orth.md#commands)
