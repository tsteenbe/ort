...
- Code
  - [model/src/main/kotlin/config/LicenseFilePatterns.kt][LicenseFilePatterns.kt]
...
- How-to guides
  - [How to include license texts](../../how-to-guides/how-to-include-license-texts.md)
- Reference
  - [ORT Reporter CLI](../cli/reporter.md#configuration-options)

[LicenseFilePatterns.kt]: https://github.com/oss-review-toolkit/ort/blob/main/model/src/main/kotlin/config/LicenseFilePatterns.kt
