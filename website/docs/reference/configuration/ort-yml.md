...
- Examples
  - [*.ort.yml files in examples/](https://github.com/oss-review-toolkit/ort/blob/main/examples/)
- How-to guides
  ...
  - [How to make snippet choices](../../how-to-guides/how-to-make-a-snippet-choices.md)
- JSON schema
...
- Reference
  - [ORT Analyzer CLI --repository-configuration-file option](../cli/evaluator.md#configuration-options)
  - [ORT Helper CLI --repository-configuration command](../cli/orth.md#commands)
  - [ORT Evaluator CLI --repository-configuration-file option](../cli/evaluator.md#configuration-options)
  - [ORT Reporter CLI --custom-license-texts-dir, --repository-configuration-file and --package-configurations-dir options](../cli/reporter.md#configuration-options)
