...
- Code
  - [model/src/main/kotlin/ScanSummary.kt](https://github.com/oss-review-toolkit/ort/blob/main/model/src/main/kotlin/ScanSummary.kt)
- Examples
...
- Reference
  - [ORT Helper CLI --input-copyright-garbage-file and --output-copyright-garbage-file commands](../cli/orth.md#commands)
