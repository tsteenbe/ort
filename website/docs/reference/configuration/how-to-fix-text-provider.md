...
- Examples
  ...
  - [FIXME how-to-fix-text-provider.kts within the ort-config repository](https://github.com/oss-review-toolkit/ort-config/blob/main/how-to-fix-text-provider.kts)
- How-to guides
