...
The [`PlainTextTemplateReporter`][PlainTextTemplateReporter.kt] enables customization of the generated attribution notices with [Apache Freemarker][Freemarker] templates and producing any other arbitrary plain text files, such as `.adoc` files.
...
- Reference
  - [ORT Reporter CLI --report-formats option](../cli/reporter.md#configuration-options)
...
[PlainTextTemplateReporter.kt]: https://github.com/oss-review-toolkit/ort/blob/main/plugins/reporters/freemarker/src/main/kotlin/PlainTextTemplateReporter.kt
