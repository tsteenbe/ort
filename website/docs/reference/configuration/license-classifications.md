...
- Examples
  - [examples/license-classifications.yml](https://github.com/oss-review-toolkit/ort/blob/main/examples/copyright-garbage.yml)
...
- Reference
  - [ORT Downloader CLI --license-classifications-file option](../cli/downloader.md#configuration-options)
  - [ORT Evaluator CLI --license-classifications-file option](../cli/evaluator.md#configuration-options)
  - [ORT Helper CLI --license-classifications command](../cli/orth.md#commands)
  - [ORT Reporter CLI --license-classifications-file option](../cli/reporter.md#configuration-options)
